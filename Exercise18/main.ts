...
let placeToVisit : string[] = ["South Korea", "Spain","Japan","Iceland","Natherland"];
...
console.log("Reverse order of original list:",placeToVisit);

placeToVisit.reverse();

console.log("Back to original order of list:",placeToVisit);
